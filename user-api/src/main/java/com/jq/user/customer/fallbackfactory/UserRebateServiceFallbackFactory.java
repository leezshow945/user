...
@Component
public class UserRebateServiceFallbackFactory implements FallbackFactory<UserRebateService> {
    private static final Logger logger = LoggerFactory.getLogger(UserRebateServiceFallbackFactory.class);

    @Override
    public UserRebateService create(Throwable throwable) {
        return new UserRebateService() {
            @Override
            ...
            @Override
            public ApiResult getPathByApi(Long userId) {
                logger.error("fallback method was: {} ,reason : ", Thread.currentThread().getStackTrace()[1].getMethodName(), throwable);
                return RPCResult.fail();
            }
            ...
            @Override
            public ApiResult<Boolean> transferBatchApi(Long destId, String destName,
                                                       String userIds, String managerUserName) {
                logger.error("fallback method was: {} ,reason : ", Thread.currentThread().getStackTrace()[1].getMethodName(), throwable);
                return RPCResult.fail();
            }

            @Override
            public ApiResult<Boolean> transferApi(Long destId, Long sourceId,
                                                  String destName, String sourceName,
            ...
            @Override
            public ApiResult getProxyLine(Long userId) {
                logger.error("fallback method was: {} ,reason : ", Thread.currentThread().getStackTrace()[1].getMethodName(), throwable);
                return RPCResult.fail();
            }
            ...
            @Override
            public ApiResult setBanRebateUserApi(String userName, Long siteId) {
                logger.error("fallback method was: {} ,reason : ", Thread.currentThread().getStackTrace()[1].getMethodName(), throwable);
                return RPCResult.fail();
            }
